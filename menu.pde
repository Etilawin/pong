...
void personaliser() {
  ...
  fill(TexteR, TexteV, TexteB);
  text(" Modifie les rectangles ! ", width/2, 200);

  fill(0, 0, 0);
  rect(width-(width-20), 250, 50, 50);

  fill(255, 0, 0);
  rect(width-(width/1.5), 250, 50, 50);

  fill(0, 128, 255);
  rect(width-(width/1.2), 250, 50, 50);

  fill(128, 255, 0);
  rect(width-(width/3), 250, 50, 50);

  fill(128, 128, 128);
  rect(width-(width/2), 250, 50, 50);

  fill(64, 0, 128);
  rect(width-(width/6), 250, 50, 50);


  fill(255, 255, 255);
  rect(width-70, 250, 50, 50);


  fill(TexteR, TexteV, TexteB);
  line(0, 360, width, 360);
  text(" Moditife la balle ! ", width/2, 400);
  ...
  fill(TexteR, TexteV, TexteB);
  text("Modifie le fond ! ", width/2, 600 );
  ...
  fill(TexteR, TexteV, TexteB);
  text("Modifie la couleur du texte !", width/2, 800);
  ...
  line(0, 960, width, 960);
  fill(TexteR, TexteV, TexteB);
  text("Appuies sur 'm' pour revenir au menu ! ", width/2, 1000 );
